...
RSpec.describe Authors::Edit, type: :model do
  describe '.call' do
    ...
    context 'when user is not signed in' do
      params = { 'name' => 'Agatha Christie', 'birth_date(1i)' => '2022', 'birth_date(2i)' => '9',
                 'birth_date(3i)' => '29' }
      subject(:object) { Authors::Edit.new(nil, author, params) }
    ...
    context 'when user is not an admin' do
      params = { 'name' => 'Agatha Christie', 'birth_date(1i)' => '2022', 'birth_date(2i)' => '9',
                 'birth_date(3i)' => '29' }
      subject(:object) { Authors::Edit.new(user, author, params) }
    ...
    context 'when user is admin' do
      context "and author's name is changed to blank" do
        params = { 'name' => '' }
        subject(:object) { Authors::Edit.new(admin, author, params) }
      ...
      context "and author's birth_date is changed to blank" do
        ...
        it "successfully updates author's birth_date" do
          Authors::Edit.new(admin, author, params).call
